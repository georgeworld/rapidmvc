 ...
 * holder.
 */
package com.georgeinfo.rapidmvc.dependents.uri.internal;
...
public class UriTemplateParser {
    ...
    private void parse(final CharacterIterator ci) {
        try {
            ...
            throw new IllegalArgumentException("##ERROR_TEMPLATE_PARSER_INVALID_SYNTAX_TERMINATED" + template, ex);
        }
    }
    ...
    private int parseName(final CharacterIterator ci, int skipGroup) {
        ...
        if (Character.isLetterOrDigit(c) || c == '_') {
            ...
            throw new IllegalArgumentException("##ERROR_TEMPLATE_PARSER_ILLEGAL_CHAR_START_NAME" + template);
        }
            ...
            if (Character.isLetterOrDigit(c) || c == '_' || c == '-' || c == '.') {
                ...
                if (c == ':') {
                    ...
                    throw new IllegalArgumentException(
                            "## ERROR_TEMPLATE_PARSER_ILLEGAL_CHAR_AFTER_NAME" + template);
                }
            } else {
                throw new IllegalArgumentException(
                        "## ERROR_TEMPLATE_PARSER_ILLEGAL_CHAR_PART_OF_NAME" + template);
            }
        }
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "## ERROR_TEMPLATE_PARSER_INVALID_SYNTAX" + template, ex);
        }
