 ...
 */
public class MissingHttpResponseException extends RuntimeException {
     ...
     */
    public MissingHttpResponseException() {
        super();
    }
     ...
     */
    public MissingHttpResponseException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public MissingHttpResponseException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public MissingHttpResponseException(Throwable cause) {
        super(cause);
    }
}
