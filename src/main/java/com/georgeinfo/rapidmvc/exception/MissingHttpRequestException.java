 ...
 */
public class MissingHttpRequestException extends RuntimeException {
     ...
     */
    public MissingHttpRequestException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public MissingHttpRequestException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public MissingHttpRequestException(Throwable cause) {
        super(cause);
    }
}
