...
/**
 * 不支持的控制器方法Render返回值的异常
 *
 * @author George <Georgeinfo@163.com>
 */
public class MissingViewNameException extends RuntimeException {
     ...
     */
    public MissingViewNameException() {
        super();
    }
     ...
     */
    public MissingViewNameException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public MissingViewNameException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public MissingViewNameException(Throwable cause) {
        super(cause);
    }
}
