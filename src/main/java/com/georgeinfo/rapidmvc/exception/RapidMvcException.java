 ...
 */
public class RapidMvcException extends RuntimeException {
     ...
     */
    public RapidMvcException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public RapidMvcException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public RapidMvcException(Throwable cause) {
        super(cause);
    }
}
